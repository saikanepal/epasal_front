...
const T1SubProduct = () => {
    ...
    const subProductsProps = {
        products, addToCart, categories, subCategories, previewMode, store, setStore, subProductType, CategorySelector, AddProduct: ProductForm, ProductCard, useDraggable,handleAddToCartAnalytics
    };
