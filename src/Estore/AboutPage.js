...
const AboutPage = ({ logoUrl }) => {
    ...
    return (
        ...
        >
            ...
            <button onClick={handleSave} className="absolute bottom-5 right-5 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded">Save</button>
        </motion.div>
    );
};
