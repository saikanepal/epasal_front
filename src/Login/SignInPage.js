                ...
                <>
                    ...
                    <div className="flex items-center justify-center lg:min-h-screen bg-[#EEEEEE]">
                        <div className="relative flex flex-col justify-center gap-16 p-8 md:p-10 m-6 space-y-8 bg-white shadow-2xl rounded-2xl md:flex-row md:space-y-0">
                            ...
                            <div className={`hidden md:flex border-l border-gray-600 ${isSignIn ? "h-[400px]" : "h-[600px]"} w-1`}></div>
                            {/* right side */}
                            <div className="hidden md:flex flex-col gap-3 justify-center items-center px-2 ">
                                <img
                                ...
                                {/* <svg width="183" height="106" viewBox="0 0 730 400" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <div className='flex gap-5 mt-10'>
                                    <a href="http://"><div className='w-12 h-12 cursor-pointer text-white bg-[#ff793b] flex justify-center items-center rounded-full'><FaDiscord size={25} /></div></a>
                                    <a href="http://"><div className='w-12 h-12 cursor-pointer text-white bg-[#ff793b] flex justify-center items-center rounded-full'><FaLinkedinIn size={25} /></div></a>
                                    <a href="http://"><div className='w-12 h-12 cursor-pointer text-white bg-[#ff793b] flex justify-center items-center rounded-full'><FaFacebookF size={25} /></div></a>
                                    <a href="http://"><div className='w-12 h-12 cursor-pointer text-white bg-[#ff793b] flex justify-center items-center rounded-full'> <FaInstagram size={25} /></div></a>
                                </div> */}
                                {/* <h1 className='text-2xl md:text-3xl tracking-wide font-Saira font-semibold text-orange-500'>Shop At Banau</h1> */}
                            </div>
                        </div>
                    </div>
