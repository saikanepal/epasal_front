...
const SliderNavbar = () => {
    return (
        <div className="bg-[#2D2D2D] mx-4 text-white flex items-center justify-center space-x-[360px] p-4 rounded-lg shadow-lg hover:shadow-2xl transition-shadow duration-300">
