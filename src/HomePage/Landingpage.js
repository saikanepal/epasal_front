...
function Landingpage() {
  return (
    <div className="lg:flex mx-5 lg:max-h-[800px] bg-white">
      <div className="flex flex-col mb-5 mt-5 lg:w-1/2 justify-between items-center p-6 lg:p-8 space-y-8 lg:space-y-0 bg-gray-50 border border-gray-200 rounded-xl shadow-lg">
      ...
      <div className="w-full lg:w-1/2 p-4">
        <div className="relative p-2 md:p-6 border border-gray-200 rounded-3xl shadow-lg">
          <iframe className="w-full h-[350px] md:h-[500px] lg:h-[400px] 2xl:h-[520px] rounded-xl" src="https://www.youtube.com/embed/GpeRIjffJXk?si=6j0u7LEKRGjZDL3W" title="Why Banau?" frameBorder="0" allowFullScreen></iframe>
        </div>
      </div>
    </div>
  );
