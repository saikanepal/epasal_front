            ...
            <div className="flex gap-5 lg:gap-10 p-8 lg:p-10 xl:p-16 bg-gray-800 rounded-lg text-white">
                ...
                <div className="hidden md:flex">
                    <div className="flex items-center h-80 lg:h-96 space-x-4">
                        <div className="w-[130px] lg:w-[160px] xl:w-[210px] md:h-[302px] lg:h-[382px] rounded-lg xl:rounded-xl bg-[#E6E6FA] flex card hover:card-flip">
                            <div className="card-inner">
                                <div className="card-front flex items-center justify-center">
                                    <span className="text-sm xl:text-base text-[#575799] font-semibold">Lavender</span>
                                </div>
                                <div className="card-back p-4 flex flex-col bg-[#E6E6FA] text-[#575799] gap-2 rounded-lg xl:rounded-xl">
                                    <h1 className="text-sm xl:text-lg font-semibold">Lavender </h1>
                        ...
                        <div className="w-[130px] lg:w-[160px] xl:w-[210px] md:h-[224px] lg:h-[304px] rounded-lg xl:rounded-xl bg-[#F6E0B5] flex items-center justify-center card hover:card-flip">
                            <div className="card-inner">
                                <div className="card-front flex items-center justify-center">
                                    <span className="text-sm xl:text-base text-[#796D55] font-semibold">Wheat Yellow</span>
                                </div>
                                <div className="card-back p-4 flex flex-col bg-[#F6E0B5] text-[#796D55] gap-2 rounded-lg xl:rounded-xl">
                                    <h1 className="text-sm xl:text-lg font-semibold">Wheat Yellow </h1>
                        ...
                        <div className="w-[130px] lg:w-[160px] xl:w-[210px] md:h-[150px]  lg:h-[240px] rounded-lg xl:rounded-xl bg-gray-200 flex items-center justify-center card hover:card-flip">
                            <div className="card-inner">
                                <div className="card-front flex items-center justify-center">
                                    <span className="text-sm xl:text-base text-[#796D55] font-semibold">Ash Beige</span>
                                </div>
                                <div className="card-back p-4 flex flex-col bg-gray-200 text-[#796D55] gap-2 rounded-lg xl:rounded-xl">
                                    <h1 className="text-sm xl:text-lg font-semibold">Ash Beige </h1>
                        ...
                        <div className="w-[130px] lg:w-[160px] xl:w-[210px] md:h-[302px] lg:h-[382px] rounded-lg xl:rounded-xl bg-[#AFCBD5] flex items-center justify-center card hover:card-flip">
                            <div className="card-inner">
                                <div className="card-front flex items-center justify-center">
                                    <span className="text-sm xl:text-base text-[#40545B] font-semibold">Fresh Blue</span>
                                </div>
                                <div className="card-back p-4 flex flex-col bg-[#AFCBD5] text-[#40545B] gap-2 rounded-lg xl:rounded-xl">
                                    <h1 className="text-sm xl:text-lg font-semibold">Fresh Blue </h1>
