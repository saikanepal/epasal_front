    ...
    return (
        <div className='box-border py-19 mb-16'>
            <motion.div
                ...
                style={{
                    // `url(${isMobile ? store?.mobileBanner?.bannerUrl : store?.banner?.bannerUrl})`
                    ...
                    <>
                        {!open ? (
                            ...
                            <div className='flex justify-center items-center w-full'>
                                <div className="relative z-20 p-5 font-Poppins px-5 md:px-0 w-full md:w-1/2 lg:w-1/3 bg-gray-100 flex-col ">
                                    <button
