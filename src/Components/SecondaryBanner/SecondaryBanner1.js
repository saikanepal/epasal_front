...
//       <motion.div
//         className="box-border font-roboto relative shadow-lg min-h-[300px] sm:min-h-[400px] md:min-h-[400px] lg:min-h-[450px] flex flex-col sm:flex-col md:flex-col lg:flex-row justify-between items-center text-black"
...
//             src={bgImage}
//             alt="Product"
//             className="w-full h-60 sm:h-[400px] md:h-[400px] lg:h-[450px] object-contain"
//           />
//         </div>
//         <div className="w-full sm:w-full md:w-full lg:w-1/2 flex flex-col justify-center items-start p-4 sm:py-1 md:py-1 lg:py-1 h-full font-Roboto">
//           {previewMode ? (
//             <>
//               <h2
...
//                 className="text-3xl lg:text-5xl xl:text-6xl font-bold mb-2"
//                 style={{ color: color.secondaryBannerColor.textColor }}
...
//           )}
//           <button
//             className="mt-4 md:mt-4 lg:mt-12 inline-block h-10 rounded border-2 border-success px-6 pb-[6px] text-xs md:text-xs lg:text-base font-medium uppercase leading-normal text-success transition duration-150 ease-in-out hover:border-success-600 hover:bg-success-50/50 hover:text-success-600 focus:border-success-600 focus:bg-success-50/50 focus:text-success-600 focus:outline-none focus:ring-0 active:border-success-700 active:text-success-700 motion-reduce:transition-none hover:border-2"
//             style={{
