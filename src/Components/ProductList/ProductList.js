...
import Theme2ProductListCard1 from './Theme2/ProductListCard1';
...
const ProductList = ({ productListProps, productListType, storeName }) => {
    const { products, isEdit, productColor, setStore, store, fetchedFromBackend, isVisitorAddToCart, setIsVisitorAddToCart, activeTheme } = productListProps
                    ...
                    case 'default':
                        return (
                            <div className='space-y-10 py-10 flex items-center flex-col mb-16 rounded-sm' style={{ backgroundColor: productColor.backgroundColor }}>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 2xl:grid-cols-5 rounded-lg gap-x-10 gap-y-12 lg:gap-20 ">
