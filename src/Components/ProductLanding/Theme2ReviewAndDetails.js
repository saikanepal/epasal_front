...
const Theme2ReviewAndDetails = ({ product }) => {
            ...
            <div className="mt-6">
                {activeTab === 'details' && (
                    <div>
                        ...
                        <p className="text-sm md:text-base text-gray-600 2xl:text-lg">{product.description}</p>
                    </div>
                )}
...
export default Theme2ReviewAndDetails;
