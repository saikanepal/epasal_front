                                    ...
                                    <div className="flex flex-row md:flex-col gap-3">
                                        ...
                                        {selectedProduct.variant.map((variant, variantIndex) => (
                                            ...
                                            selectedProduct.variant[0].options.map((option, optionIndex) => (
                                                ...
                                                >
                                                    <img src={option?.image?.imageUrl || selectedProduct?.image?.imageUrl} alt={option.name} className="w-16 h-16 lg:w-20 lg:h-20 rounded-xl object-cover transition-transform duration-300 hover:scale-105" />
                                                </div>
                                            ))
                                        ))}
                                    </div>
