        ...
        <a href="#">
            ...
            <div className="px-4 py-3 w-72">
                ...
                <div className="flex items-center">
                    <p className="text-lg font-semibold text-black cursor-auto my-3"> Rs 99</p>
                    <del>
                        <p className="text-sm text-gray-600 cursor-auto ml-2"> Rs 150</p>
                    </del>
...
const ProductCard3 = () => (
    <div className="product-card w-[300px] rounded-md shadow-xl overflow-hidden  relative cursor-pointer snap-start shrink-0 py-8 px-4 bg-white flex flex-col items-center justify-center gap-3 transition-all duration-300 group">
        ...
        <div
            className="w-[200px] aspect-square relative  after:absolute after:h-1 after:w-full flex justify-center flex-col items-center after:opacity-0 after:bg-[#7b956a] after:top-8 after:left-0 after:group-hover:opacity-100 after:translate-x-1/2 after:translate-y-1/2 after:-z-20 after:group-hover:w-full flex justify-center flex-col items-center after:transition-all after:duration-300 after:group-hover:origin-right after:group-hover:-translate-x-1/2 group-hover:translate-x-1/2 transition-all duration-300"
        >
            <img
                src={cosmetic}
                alt="Product"
                    ...
                    {productCardsArray.map((card, index) => (
                        <>
                            <div className=' flex flex-col w-[90%] sm:w-[75%] lg:w-[35%] mx-auto h-[500px]'>
                                ...
                                <div>
                                    <button
                                        className="flex max-w-[300px] w-full  items-center justify-center space-x-5 mt-auto text-green-800 bg-gray-300 border-0 py-3 px-4  focus:outline-none hover:text-white hover:bg-gray-700 rounded"
