...
const Footer1 = ({
    ...
    if (!previewMode) {
        ...
        return (
            <footer style={{ backgroundColor: bgColor, color: textColor, fontFamily: store?.fonts?.Footer }} className="lg:px-10 md:px-8  px-1 pt-14 pb-4">
                <div className="container mx-auto grid grid-cols-2 md:grid-cols-4 justify-center gap-10 md:gap-14 lg:gap-36 ">
                    <div className='flex gap-5 '>
                        {logo && <img src={logo.logoUrl} alt="Store Logo" className="h-16 w-28 rounded-full w-auto" />}
                        <div className="mb-4">
