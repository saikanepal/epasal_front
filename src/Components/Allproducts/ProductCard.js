...
//           style={{color: storeMIni.color.subProductColor.starColor}
//           }>
//             &#9733;
//           </span>
//         ))}
...
const ProductCard = ({ product }) => {
  ...
  const renderStars = (rating) => {
    ...
    return (
      <div className="flex text-xl">
        {[...Array(fullStars)].map((_, index) => (
          <span key={index} className="" style={{ color: storeMIni.color.subProductColor.starColor }}>
            &#9733;
          </span>
        ))}
        {halfStar && (
          <span className="relative" style={{ color: storeMIni.color.subProductColor.starColor }}>
            <span className="absolute w-1/2 overflow-hidden" style={{ width: '50%' }}>
              &#9733;
            </span>
            <span className="text-gray-300">
    ...
    >
      ...
      <div className="my-auto py-1">
        ...
        <div className="flex justify-between items-center mt-1">
          <div className="flex justify-between gap-2">
            <img
              src={defaultVariant.image.imageUrl}
              alt="default"
              className="w-8 h-8 object-cover cursor-pointer"
