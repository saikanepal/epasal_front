...
//   color
// }) => {
//   const textColor = color.subcategoryColor.textColor ;
//   const backgroundColor = color?.productListColor.textColor ;
//   const customColor = color?.subcategoryColor.text;
//   const sideBarBorder = color?.productListColor.sideBarBorder ;
