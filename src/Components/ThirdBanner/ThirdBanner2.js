...
import { useStore } from "../../Theme/Theme2/T2Context"; // Adjust the path as necessary
import { useImage } from "../../Hooks/useImage";
import { Link } from "react-router-dom";
const ThirdBanner2 = ({ previewMode, isEdit, defaultBgImage, storeName }) => {
